\DIDINFO{SSS-3.1.0 :: If the system is required to operate in more than one state or mode having requirements distinct from other states or modes, this section shall identify and define each state and mode. 
