\DIDINFO{SSS-3.0.0 :: This chapter shall be divided into the following sections to specify the system requirements, that is, those characteristics of the system that are conditions for its acceptance.
