...
A summary of the modes for each sub-state and state is provided in Table~\ref{tab:Light-StatesAndModes} below.
...
%\paragraph{Sub-States}
%\RequirementNumberAM{subsubsection}{3.1.1.1}
%\label{loc:light_substates}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Modes}
\RequirementNumberAM{subsubsection}{3.1.1}
...
\label{loc:LightRadioSubMode}

\input{sections/3.01.StatesAndModes/Light/Light-SubModes-Radio.tex}

%
%%-----------------------------------------
\paragraph{Cellular Sub-Modes}
\RequirementNumberAM{paragraph}{3.1.4.2}
\label{loc:LightCellSubMode}

\input{sections/3.01.StatesAndModes/Light/Light-SubModes-Cell.tex}
