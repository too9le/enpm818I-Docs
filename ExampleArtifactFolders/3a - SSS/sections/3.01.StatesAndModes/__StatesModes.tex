...
\subsection{BDP-Light}
\input{sections/3.01.StatesAndModes/Light/Light-__StatesModes.tex}

\subsection{BDP-Medium}
\input{sections/3.01.StatesAndModes/Medium/Medium-__StatesModes.tex}

\subsection{BDP-Heavy}
\input{sections/3.01.StatesAndModes/Heavy/Heavy-__StatesModes.tex}
...
%
%\input{sections/3.01.StatesAndModes/Light/Light-States.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% sub-states would go here as section 3.1.2 but we're not going to drill down that far 
%\subsubsubsection{Sub-States}
%\RequirementNumberAM{subsubsection}{3.1.1.1}
%\label{loc:ssec_substates}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsubsection{Modes}
%\RequirementNumberAM{subsubsection}{3.1.2}
%\label{loc:ssec_modes}
%
...
%
%\input{sections/3.01.StatesAndModes/Light/Light-Modes.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{SubModes}
%\RequirementNumberAM{subsection}{3.1.2.1}
%\label{loc:ssec_submodes}
%
...
%
%This section will be filled in later, as the details of the sub-modes are clarified.


%%-----------------------------------------
%\subsubsection{Mode 1 Sub-Modes}
%\RequirementNumberAM{subsubsection}{3.1.4.1}
%\label{loc:ModeOneSubModes}
%
%\input{sections/3.01.StatesAndModes/SubModes.tex}
%
%
%%-----------------------------------------
%\subsubsection{Mode 2 Sub-Modes}
%\RequirementNumberAM{subsubsection}{3.1.4.2}
%\label{loc:ModeTwoSubModes}
%
%\input{sections/3.01.StatesAndModes/SubModes.tex}
