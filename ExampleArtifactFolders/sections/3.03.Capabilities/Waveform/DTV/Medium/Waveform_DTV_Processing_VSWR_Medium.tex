...
{\RqtNumberBase.1}
% #2 is Title
{BDP-Medium \DTV Waveform \VSWR Input Processing}
% #3 is requirement label (expected to be of form rqt:XXX)
{rqt:Waveform_DTV_Medium_VSWR_Input}
% #4 is Text of the specification
{The BDP-Medium system shall calculate the Average Reflected Power from the \DTV Received \RF Data signal, all controlled by the parameters of the Waveform Control Inputs.}
...
{\RqtNumberBase.2}
% #2 is Title
{BDP-Medium \DTV Waveform \VSWR Output Processing}
% #3 is requirement label (expected to be of form rqt:XXX)
{rqt:Waveform_DTV_Medium_VSWR_Output}
% #4 is Text of the specification
