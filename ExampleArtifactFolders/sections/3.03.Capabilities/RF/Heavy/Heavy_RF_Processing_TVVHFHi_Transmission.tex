...
{rqt:Heavy_RF_TVVHFHi_Transmission_Processing}
% #4 is Text of the specification
{The BDP-Heavy system shall filter, amplify, and radiate the \TVVHFHigh \RF Broadcast Pre-Amp Data along with producing an \RF signal that is representative of the reflected \RF power.}
