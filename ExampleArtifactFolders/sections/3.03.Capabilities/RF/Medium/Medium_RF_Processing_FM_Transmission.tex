%An overview the \FM \RF transmission processing performed is shown in Figure~\ref{fig:Medium_RF_Processing_FM_Transmission}.
%\begin{figure}[htbp]
	%\centering
		%\includegraphics[width=6.5in]{../zProjectWideData/images/RFProcessing_Medium_FM_Transmission_300dpi_6500millWide.eps}
	%\caption[BDP-Medium FM RF Transmission Processing Overview]{BDP-Medium FM RF Transmission Processing Overview}
	%\label{fig:Medium_RF_Processing_FM_Transmission}
%\end{figure}
