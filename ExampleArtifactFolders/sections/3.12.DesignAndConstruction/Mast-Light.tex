...
{\RqtNumberBase.1}
% #2 is Title
{BDP-Light Mast and Antenna Employment}
% #3 is requirement label (expected to be of form rqt:XXX)
{rqt:DesignDefences_MastLight}
% #4 is Text of the specification
{The BDP-Light system shall be erectable by a three (3) person team.}
...
% #7 is Traceability
{
\item [5.5.17.2] Section in CDD for BDP FoS~\cite{ref__BDP_FOS_CDD}.
}
