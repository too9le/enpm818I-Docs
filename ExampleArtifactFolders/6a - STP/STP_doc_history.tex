%%% SVN stuff
\svnidlong
{$HeadURL: https://svn.riouxsvn.com/kneadlatxinputs/ExampleArtifactFolders/6a%20-%20STP/STP_doc_history.tex $}
{$LastChangedDate: 2023-12-24 22:32:41 -0500 (Sun, 24 Dec 2023) $}
{$LastChangedRevision: 34 $}
{$LastChangedBy: KneadProject $}
\svnid{$Id: STP_doc_history.tex 34 2023-12-25 03:32:41Z KneadProject $}
...
\begin{table}[h]
    ...
    \multicolumn{4}{l}{\bfseries Change Record} \\
		...
		\hline
		\hline
			 25 Dec	2023	&	\centering	P1	&	{\raggedright Lewis Collier}	&	2nd draft version \\ \hline
		\hline		
		\hline				
  	\end{tabular}
