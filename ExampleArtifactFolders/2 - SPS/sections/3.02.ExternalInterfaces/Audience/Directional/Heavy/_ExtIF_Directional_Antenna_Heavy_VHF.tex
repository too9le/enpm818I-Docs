...
{rqt:Directional Antenna VHF Heavy}
% #4 is Synopsis
{The BDP-Heavy system shall deliver a \VHF transmission to an audience in a directional pattern from the transmitting source.}%1dA
% #5 is Specifics
{
	\item The range of the \VHF transmission shall reach at least 10 miles.
}
% #6 is Acceptance
...
%{The BDP-Medium system shall deliver an \VHF transmission to an audience in a directional pattern from the transmitting source.}%1dA
